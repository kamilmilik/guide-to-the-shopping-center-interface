 ...
 */
public class TodayFilmsFragment extends Fragment {
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;

    public TodayFilmsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_today_films, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.my_recycler_view_today_films);
        ...
        String[] labelsArray1 = {"Lego Ninjago","Twoj Vincent","To", "Pierwszy Snieg","My Little Pony"};
        String[] labelsArray2 = {"2D Napisy","3D Napisy","2D napisy","2D Napisy", "3D Lektor"};
        int[] imagesArray = {R.drawable.lego_ninjago_pl_cf65c6368c, R.drawable.vincent,R.drawable.to,R.drawable.pierwszy_snieg,R.drawable.pony};
